...
public class P2p6_IS22{
	public static void main(String[] args) {
		...
		System.out.println("El valor de la posicion 3 es: " + numeros[2]);
		...
		for (a=0;a<calif.length;a++){
			System.out.println("Ingrese el valor de la posicion #"+ a);
        ...
        String[] cadenas1 = new String[]{"uno","dos","tres","cuatro","cinco", "seis", "siete", "ocho", "nueve", "diez"};
